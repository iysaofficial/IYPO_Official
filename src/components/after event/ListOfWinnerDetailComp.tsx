...
import iypoWinnerData from './iypoWinnerData.json';

interface WinnerDetailProps {
    year: string;
}

const IypoListOfWinnerDetailComp: React.FC<WinnerDetailProps> = ({ year }) => {
    const data = iypoWinnerData[year as keyof typeof iypoWinnerData];
...
export default IypoListOfWinnerDetailComp;
